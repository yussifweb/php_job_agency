...
<html lang="en">
  ...
  <body>
    ...
    if( isset( $_POST['submit'] ) ){
        ...
        $sql = "INSERT INTO clients (name, email, age, phone, industry, levelRadios, region, district, image) VALUES ( '$name', '$email', '$age', '$phone', '$industry', '$levelRadios', '$region', '$district', '$image' )";
