  ...
  <main class="container">
        ...
        <form id="survey-form" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="age" name="age" value="<?php echo $company['age']; ?>" placeholder="Age" required>
                </div>
    ...
    if( isset( $_POST['update'] ) ){
        ...
        $sql = "UPDATE clients SET name='$name', email='$email', age='$age', phone='$phone', industry='$industry', levelRadios='$levelRadios', region='$region', district='$district', image='$image'  WHERE id='$id'";

        if (move_uploaded_file($_FILES['image']['tmp_name'], $target) && mysqli_query($connect, $sql)) {
            echo "header('Location: clients.php');";;
        } else {
